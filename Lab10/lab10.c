...
Attaching the slides discussed in the lecture containing an example.
...
For the given example, the Name table is as below. Namelist contains only Value_Numbers. Further a single Value_Number might be representing multiple redundant names. For eg: "e and i are having same value number i.e. 3"

Namelist | constvalue | constflag
1 | 10 | 1
2 | 40 | 1
7 | 150 | 1
*/
